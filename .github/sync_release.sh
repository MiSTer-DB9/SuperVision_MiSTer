...
UPSTREAM_REPO="https://github.com/MiSTer-devel/SuperVision_MiSTer.git"
CORE_NAME=(SuperVision)
...
UPSTREAM_CORE_NAME=(SuperVision)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Supervision.qpf)
COMPILATION_OUTPUT=(output_files/Supervision.rbf)
